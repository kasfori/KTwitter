...

{
    ...
    [self.account.twitter verifyCredentialsWithUserSuccessBlock:^(NSString *username, NSString *userID) {
        ...
        [self.account.twitter getFavoritesListWithUserID:nil orScreenName:scrname count:@"30" sinceID:params[@"since_id"] maxID:nil includeEntities:nil successBlock:^(NSArray *statuses) {
...
- (void)loadMoreStatus
{
    ...
    [self.account.twitter verifyCredentialsWithUserSuccessBlock:^(NSString *username, NSString *userID) {
        ...
        [self.account.twitter getFavoritesListWithUserID:userID orScreenName:nil count:@"30" sinceID:params[@"since_id"] maxID:nil includeEntities:nil successBlock:^(NSArray *statuses) {
            NSArray *newStatuses = [Tweet mj_objectArrayWithKeyValuesArray:statuses];
