...
{
    NSArray *array = [[NSMutableArray alloc] initWithObjects:self.tweet.media_url0,self.tweet.media_url1,self.tweet.media_url2, nil];
...
{
    static NSString *identifier= @"mediaTweet2";
    MediaCell2 *cell=[tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        
        cell=[[[NSBundle mainBundle]loadNibNamed:@"MediaCell2" owner:nil options:nil] firstObject];
